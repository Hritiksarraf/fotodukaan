...
export default function page() {
  return (
    <>
      <div className="pt-20 ">
        <div className='w-[100vw] h-[80vh] bg-cover bg-center pt-20 bg-[url("/assets/about-pic.jpg")]'>
        ...
        <section>
          ...
          <div className="bg-cover  bg-center w-full my-8  flex flex-col md:flex-row text-center md:text-left bg-gradient-to-b md:bg-gradient-to-r from-blue-400 to-blue-600">
              ...
              <div className='mt-9'>
                ...
                <div className='flex'>
                  ...
                  <div className='ml-2 '>
                    ...
                    <p className="md:text-sm  text-left text-black md:pr-64  font-serif text-[0.6rem]">Our platform helps you increase your visibility and land more gigs.</p>
                ...
                <div className='flex mt-8'>
                  ...
                  <div className='ml-2 '>
                    ...
                    <p className="md:text-sm  text-left text-black md:pr-64  font-serif text-[0.6rem]">Once your profile is set up, clients can start booking your services right away.</p>
                ...
                <div className='flex mt-8'>
                  ...
                  <div className='ml-2 '>
                    <h1 className='text-xl md:text-3xl font-serif text-left text-black '>Simple Registration Process</h1>
                    <p className="md:text-sm md:pr-64 text-left text-black font-serif text-[0.6rem]">We’ve made the registration process quick and hassle-free! Just:
        ...
        <section>
          ...
          <div className="bg-cover  bg-center w-full my-8  flex flex-col md:flex-row-reverse text-center md:text-left bg-gradient-to-b md:bg-gradient-to-r from-yellow-400 to-yellow-300">
        ...
        <section>
          ...
          <div className="bg-cover  bg-center w-full my-8  flex flex-col md:flex-row text-center md:text-left bg-gradient-to-b md:bg-gradient-to-r from-blue-400 to-blue-600">
            ...
            <div className="w-full md:w-[60%] px-7 py-10 md:px-20 md:py-20">
              ...
              <p className="  md:text-sm mt-2  md:mt-5 m-auto md:pr-20 font-serif text-left text-black text-[0.9rem]">Recognizing this gap, Fotodukaan.com was established as a dedicated platform where freelancers can display their portfolios and connect with clients seamlessly. Our mission is to empower freelance photographers, cinematographers, drone operators, and video editors by providing them with a platform to showcase their talents, and to offer clients a convenient, reliable way to find the perfect professionals for their needs.</p>
              <p className="  md:text-sm mt-2  md:mt-5 m-auto md:pr-20 font-serif text-left text-black text-[0.6rem]">From weddings and birthdays to corporate events and personal projects, Fotodukaan.com aims to be a trusted partner in every significant life event. We believe in the power of visual storytelling and the importance of preserving memories, and we are committed to making high-quality photography and videography accessible to everyone across India.</p>
              <p className="  md:text-sm mt-2  md:mt-5 m-auto md:pr-20 font-serif text-left text-black text-[0.6rem]">Today, Fotodukaan.com continues to grow, bringing together a vibrant community of creatives and clients. We are proud to facilitate connections that not only create beautiful memories but also support and celebrate the incredible talent of freelance visual artists in India.</p>
