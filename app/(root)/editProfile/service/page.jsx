...
export default function page() {
    ...
    return (
        <div className='min-h-[80vh] pt-32'>
            ...
            <div>
                <section className="bg-gradient-to-b md:min-h-[100vh] min-h-[100vh] mt-10  from-white to-yellow-200 pb-20 ">
                    <div className="flex flex-col items-center    px-6  mx-auto ">

                    </div>
                    <div className="flex flex-col items-center   justify-center shadow-2xl bg-white  border-2 w-[90vw] md:w-[80vw]  px-6 py-8 mx-auto  lg:pb-0">
