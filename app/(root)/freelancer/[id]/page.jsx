    ...
    <div className='pt-20 overflow-x-hidden'>
        ...
        <section className="text-gray-600 body-font overflow-hidden  bg-gradient-to-r from-white to-white">
          <div className="container lg:w-[75vw]  md:p-10 pt-10 mx-auto  bg-white  ">
            <div className=" mx-auto px-5 py-5 shadow-2xl md:p-10 flex flex-wrap   ">
              <img alt="ecommerce" className="lg:w-1/2 h-full aspect-square w-full lg:h-auto  object-cover object-center rounded" src={freelancerData.profilePhoto} />
      ...
      <section className=' px-auto md:pr-[25vw] md:pl-[15vw] w-[100vw]'>
        ...
        <section className='my-2'>
          ...
          <div>
            <ul className='pl-5 mt-5 mb-7'>
              {policyPoints.map((point, index) => (
                <li key={index} className='text-gray-600   text-xs'> <span><DoneIcon className='text-green-900 ' /></span> {point}</li>
              ))}
            </ul>
          </div>
        </section>
